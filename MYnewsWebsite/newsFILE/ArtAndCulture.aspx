<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArtAndCulture.aspx.cs" Inherits="MYnewsWebsite.newsFILE.ArtAndCulture" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>කලා හා සංස්කෘතික පුවත්</title>
...
<body>
    ...
    <div>
        ...
        <h1>කලා හා සංස්කෘතික පුවත්</h1>
        <div  id="art" runat="server"></div> 

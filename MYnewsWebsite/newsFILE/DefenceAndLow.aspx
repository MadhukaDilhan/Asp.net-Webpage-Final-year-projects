<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefenceAndLow.aspx.cs" Inherits="MYnewsWebsite.newsFILE.DefenceAndLow" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ආරක්ෂක හා නීති පුවත්</title>
...
<body>
    ...
    <div>
        ...
        <h1>ආරක්ෂක හා නීති පුවත්</h1>
        <div  id="low" runat="server"></div> 
